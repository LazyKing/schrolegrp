...
import { registerSchoolDispatch, resetStore } from "../../actions/Register_Actions";
...
class SchoolRegisterForm extends Component {
  	...
  	handleSubmit = (e) => {
	    ...
	    this.props.form.validateFieldsAndScroll((err, values) => {
	      if (!err) {
	        const { school_name, email, password,
            confirm_password, user_type='school' } = this.props.form.getFieldsValue();
	    ...
	    return (
	        <Row type="flex" className="candidate-signup-pageContainer">
	        	...
	        	<Col>
	        		...
	        		<p>You have started the process to register school.
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(SchoolRegisterForm));
