...
import { Row, Col, Pagination, List, Avatar, Icon, Button } from 'antd';
...
class SchoolVacanciesList extends Component {
  ...
  onVacancyCreate = () => {
    browserHistory.push({
      pathname: '/schoolprofile/vacancy/new'
    });
  }
  ...
  render() {
    ...
    return (
      <div className="">
        ...
        <Button onClick={this.onVacancyCreate}>Add Vacancy</Button>
        <div className="all-vacancy-list-container" style={{ background: '#ECECEC', padding: '30px' }} >
          <Row gutter={16}>
...
function mapStateToProps(state) {
  ...
  return { vancanyList: state.schools.vacancyList };
}
